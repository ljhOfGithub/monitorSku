...
class DeviceQuery:
    ...
    @staticmethod
    def query_device_info(product_code, brand="vivo"):
        '''查询设备信息'''
        try:
            params = {
...
def save_ocr_result(product_code, ocr_text, base_dir="vivo"):
    '''保存OCR识别结果到txt文件'''
    try:
        # 确保目录存在
                ...
                try:
                    ...
                    if downloaded_path:
                        ...
                        if recognized_text:
                            ...
                            if product_code:
                                # 保存OCR结果
                                save_ocr_result(product_code, recognized_text, "vivo")
                                ...
                                query_result = DeviceQuery.query_device_info(product_code, "vivo")
